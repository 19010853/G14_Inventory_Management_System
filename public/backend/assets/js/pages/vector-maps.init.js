...
function _createClass(e, a, t) {
  return (
    a && _defineProperties(e.prototype, a),
    ...
    _createClass(e, [
      {
        ...
        value: function () {
          new jsVectorMap({
            ...
            markerStyle: { initial: { fill: '#343a40' } },
            labels: {
              markers: {
                render: function (e) {
                  return e.name;
