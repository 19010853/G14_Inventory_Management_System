...
var options = {
    ...
    series: [
      {
        name: 'Profits',
        data: [
          63, 16, 8, 22, 20, 7, 26, 10, 63, 5, 25, 19, 16, 11, 16, 1, 37, 23,
          31, 1, 24, 15, 2, 17, 5, 25, 19, 16, 11, 28,
        ],
      },
    ],
    tooltip: { theme: 'light' },
  ...
  chart = new ApexCharts(document.querySelector('#website-visitors'), options);
chart.render();
options = {
  chart: {
    type: 'area',
  ...
  series: [
    {
      name: 'Profits',
      data: [
        27, 21, 18, 24, 29, 19, 23, 3, 20, 26, 12, 28, 25, 37, 12, 18, 21, 18,
        24, 29, 19, 17, 10, 34, 9, 22, 8, 31, 18, 27,
      ],
    },
  ],
  tooltip: { theme: 'light' },
  ...
  series: [
    {
      name: 'May',
      data: [
        40, 51, 62, 70, 65, 53, 51, 46, 62, 93, 62, 61, 51, 62, 51, 66, 70, 53,
        62, 44, 53, 46, 40, 65, 55, 62, 70, 75, 78, 80,
      ],
    },
  ],
  tooltip: { theme: 'light' },
  grid: { strokeDashArray: 4 },
  xaxis: { labels: { padding: 0 }, tooltip: { enabled: !1 }, type: 'datetime' },
  yaxis: { labels: { padding: 4 } },
  labels: [
    '2020-06-21',
    '2020-06-22',
...
options = {
  ...
  plotOptions: { heatmap: { radius: 10, enableShades: !0, shadeIntensity: 2 } },
  grid: { show: !1 },
  dataLabels: { enabled: !1 },
  colors: ['#537AEF'],
