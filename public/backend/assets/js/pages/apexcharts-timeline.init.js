...
var options = {
    ...
    chart: { height: 350, type: 'rangeBar', parentHeightOffset: 0 },
  ...
  tooltip: {
    custom: function (e) {
      var t = new Date(e.y1).getFullYear(),
        ...
        n = e.ctx.w,
        i = n.globals.labels[e.dataPointIndex],
        o = n.config.series[e.seriesIndex].name || '';
      return (
        '<div class="apexcharts-tooltip-rangebar"><div> <span class="series-name" style="color: ' +
        n.globals.colors[e.seriesIndex] +
        '">' +
        (o || '') +
