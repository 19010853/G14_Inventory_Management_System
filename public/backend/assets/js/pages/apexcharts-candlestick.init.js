...
options = {
  ...
  plotOptions: {
    candlestick: { colors: { upward: '#ec8290', downward: '#537AEF' } },
  },
  xaxis: { type: 'datetime' },
};
(chart = new ApexCharts(
...
var optionsBar = {
    ...
    plotOptions: {
      bar: {
        ...
        colors: {
          ranges: [
            { from: -1e3, to: 0, color: '#ec8290' },
            { from: 1, to: 1e4, color: '#eb9d59' },
          ],
        },
      },
    },
    ...
    custom: [
      ...
      function (e) {
        ...
        return (
          ...
          e.globals.seriesCandleO[a][t] +
          '</span></div><div>High: <span class="value">' +
          e.globals.seriesCandleH[a][t] +
          '</span></div><div>Low: <span class="value">' +
          e.globals.seriesCandleL[a][t] +
          '</span></div><div>Close: <span class="value">' +
          e.globals.seriesCandleC[a][t] +
          '</span></div></div>'
        );
      },
    ],
