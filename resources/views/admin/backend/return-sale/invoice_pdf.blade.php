  ...
  <head>
    ...
    <style>
      * {
      ...
      .invoice-header {
        background-color: #dc3545; /* Fallback for gradient */
        ...
        <tr>
          ...
          <td class="info-box">
            ...
            <p>
              ...
              ${{ number_format($sales->grand_total, 2) }}
            </p>
            <p>
            ...
            <p>
              ...
              ${{ number_format($sales->due_amount, 2) }}
            </p>
          </td>
        </tr>
      </table>

      <h5 style="font-weight: bold; margin: 20px 0 10px">Return Summary</h5>
      <table class="table">
        <thead>
          <tr>
            <th>#</th>
      ...
      <table class="summary-table">
        ...
        <tr>
          <td>
            ...
            ${{ number_format($sales->shipping, 2) }}
          </td>
        </tr>
        <tr>
          <td>
